...
class File
{
   ...
   */
     ...
     * Scan files.
     */
    public static function scan(string $folder, $type = null, $file_path = true)
    {
        $data = array();
        if (is_dir($folder)) {
     ...
     * @return boolean
     */
    public static function write($filename, $content, $create_file = true, $append = false, $chmod = 0666)
    {
        // Redefine vars
        $filename    = (string) $filename;
